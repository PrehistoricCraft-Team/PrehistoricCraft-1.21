...
import net.seentro.prehistoriccraft.common.block.nature.plantStructures.neocalamites.item.NeocalamitesBlockItem;
...
public class PrehistoricItems {
    ...
    public static final DeferredItem<Item> DNA_RECOMBINATOR = ITEMS.register("dna_recombinator", () -> new DNARecombinatorBlockItem(new Item.Properties()));
