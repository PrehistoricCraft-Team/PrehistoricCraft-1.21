...
public class PrehistoricBlocks {
    ...
    public static final DeferredBlock<Block> DAWN_REDWOOD_SAPLING = registerBlock("dawn_redwood_sapling", () -> new DawnRedwoodSaplingBlock(SuspiciousStewEffects.EMPTY, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_LEAVES).replaceable().instabreak().pushReaction(PushReaction.DESTROY)));
