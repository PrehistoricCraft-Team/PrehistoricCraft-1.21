package net.seentro.prehistoriccraft.common.block.machines.dnaSeparationFilter.item;
...
public class DNASeparationFilterBlockItemModel extends GeoModel<DNASeparationFilterBlockItem> {
    ...
    public ResourceLocation getAnimationResource(DNASeparationFilterBlockItem animatable) {
        return ResourceLocation.fromNamespaceAndPath(PrehistoricCraft.MODID, "animations/block/machine/dna_separation_filter.animation.json");
    }
}
