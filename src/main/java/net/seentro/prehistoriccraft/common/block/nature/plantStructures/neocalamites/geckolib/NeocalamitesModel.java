...
public class NeocalamitesModel extends GeoModel<NeocalamitesBlockEntity> {
    ...
    public ResourceLocation getModelResource(NeocalamitesBlockEntity animatable) {
        ...
        if (animatable.getBlockState().getValue(PrehistoricBlockStateProperties.QUAD_INV_SEGMENT) == QuadrupleInvisibleSegmentProperty.TOP)
        ...
        if (animatable.getBlockState().getValue(PrehistoricBlockStateProperties.QUAD_INV_SEGMENT) == QuadrupleInvisibleSegmentProperty.MIDDLE)
        ...
        if (animatable.getBlockState().getValue(PrehistoricBlockStateProperties.QUAD_INV_SEGMENT) == QuadrupleInvisibleSegmentProperty.BASE)
