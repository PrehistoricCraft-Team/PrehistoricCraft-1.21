package net.seentro.prehistoriccraft.common.worldgen.features;
...
public class DawnRedwoodBigTreeFeature extends Feature<NoneFeatureConfiguration> {
    public DawnRedwoodBigTreeFeature(Codec<NoneFeatureConfiguration> codec) {
        super(codec);
    }
